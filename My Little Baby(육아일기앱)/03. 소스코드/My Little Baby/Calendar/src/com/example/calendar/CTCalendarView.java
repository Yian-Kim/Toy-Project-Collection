        ...
        for(int i=1;i<=maxRow;i++ )
        {
            ...
            for(int j=1;j<=maxColumn;j++)
            {
                ...
                if(dayCnt >= 0 && dayCnt < 7)
                {
                    ...
                    oneday[dayCnt].setTextDaySize(30); //일자의 글씨크기 
                    ...
                    oneday[dayCnt].setTextActcntSize(22);
                    oneday[dayCnt].setTextActcntColor(Color.BLACK);
                    oneday[dayCnt].setTextActcntTopPadding(30);
                    oneday[dayCnt].setBgSelectedDayPaint(Color.rgb(0, 162, 232));
                    oneday[dayCnt].setBgTodayPaint(Color.YELLOW);
